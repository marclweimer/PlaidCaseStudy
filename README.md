...
## Overview and Origin
Much can be said about the growth and excitement of the burgeoning FinTech space.  Many of these companies are innovative, unencumbered by the old infrastructure or business models of existing financial institutions.  Increasingly, data takes the center stage at these companies, who consume data to provide new insights for customers.  However, new companies don't innately have access to customer data or even the ability to integrate into existing financial processes.  

Thus, there must be a willingness and ability for FinTech and incumbent financial institution platforms to interact.  Building an unbundled, new financial service without this may cause onboarding friction for the consumer would be a major hindrance to capturing market share. However, in the early days of FinTech, there *was* no basic infrastructure for startups and banks to easily integrate.
